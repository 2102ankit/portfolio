        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          >
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                I'm a Software Engineer at ISS-Stoxx with a strong foundation in full-stack
                development. My journey in tech has been driven by curiosity and a passion for
                solving complex problems with elegant solutions.
              </p>
              <p>
                I specialize in the MERN stack, Python, and Spring Boot, with a keen interest
                in DevOps practices and Machine Learning. I believe in writing clean, maintainable
                code and building systems that scale.
              </p>
              <p>
                Beyond technical skills, I've held leadership positions including Finance Secretary
                at Students' Council and Training and Placement Coordinator, managing budgets and
              ...
              >
                <Card className="p-6 hover:border-foreground/20 transition-all">
                  <div className="mb-4">
                    ...
                    <p className="text-sm text-muted-foreground italic">{exp.date}</p>
                  </div>
                  <ul className="space-y-2 text-muted-foreground">
